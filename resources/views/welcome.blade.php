...
<section id="about" class="about">
  <div class="container" data-aos="fade-up">
    ...
    <div class="row">
      <div class="col-lg-4">
        <img src="{{asset('frontend/img/profile-img.jpg')}}" class="img-fluid" alt="">
      </div>
      ...
      <div class="col-lg-4 col-md-6 portfolio-item filter-web">
        <div class="portfolio-wrap">
          ...
          <div class="portfolio-info">
            ...
            <p>Web</p>
            <div class="portfolio-links">
              <a href="{{asset('frontend/img/portfolio/portfolio-2.jpg')}}" data-gallery="portfolioGallery"
      ...
      <div class="col-lg-4 col-md-6 portfolio-item filter-app">
        <div class="portfolio-wrap">
          ...
          <div class="portfolio-info">
            ...
            <p>App</p>
            <div class="portfolio-links">
              <a href="{{asset('frontend/img/portfolio/portfolio-3.jpg')}}" data-gallery="portfolioGallery"
      ...
      <div class="col-lg-4 col-md-6 portfolio-item filter-card">
        <div class="portfolio-wrap">
          ...
          <div class="portfolio-info">
            ...
            <p>Card</p>
            <div class="portfolio-links">
              <a href="{{asset('frontend/img/portfolio/portfolio-4.jpg')}}" data-gallery="portfolioGallery"
      ...
      <div class="col-lg-4 col-md-6 portfolio-item filter-web">
        <div class="portfolio-wrap">
          ...
          <div class="portfolio-info">
            ...
            <p>Web</p>
            <div class="portfolio-links">
              <a href="{{asset('frontend/img/portfolio/portfolio-5.jpg')}}" data-gallery="portfolioGallery"
      ...
      <div class="col-lg-4 col-md-6 portfolio-item filter-app">
        <div class="portfolio-wrap">
          ...
          <div class="portfolio-info">
            ...
            <p>App</p>
            <div class="portfolio-links">
              <a href="{{asset('frontend/img/portfolio/portfolio-6.jpg')}}" data-gallery="portfolioGallery"
